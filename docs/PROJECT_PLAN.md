...
- Derive a GeometrySpec-linked `AssemblyPlan` with ordered internal prototype build steps, route/feature/placement references, risk items, and explicit boundaries against DFA, injection molding, robotic assembly, and production optimization.
