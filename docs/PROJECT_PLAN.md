...
- Derive a development-board bring-up scaffold with pin map, interface map, module init stubs, test entrypoints, and checklist. This is not OTA, device runtime, long-term user programming, or production firmware.
