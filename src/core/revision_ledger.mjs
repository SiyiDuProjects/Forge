...
function revisionRecord(revision = {}, currentRevisionId = "") {
  ...
  return {
    ...
    status: {
      ...
      electronicsDescriptorTrustStatus: revision.electronicsDescriptorTrustReport?.status || "unknown",
...
function derivedOutputRecords(revision = {}) {
  ...
  const outputPresence = {
    ...
    electronicsDescriptorTrustReport: Boolean(revision.electronicsDescriptorTrustReport),
